...
📅Permanência: {dias}""")
            ...
            if welcome[1]:
                ...
                if '$rules' in welcome:
                    ...
                    rules_markup = InlineKeyboardMarkup(inline_keyboard=[[dict(text='Leia as regras',url='https://tcxsproject.com.br/doadores/')]])
            ...
            ##  ATUALIZAÇÃO PARA DOADORES ATRAVÉS DO SISTEMA DE BOTÕES------------------------------------------------------------------------------>>
                   ...
                   #LOJA HEN------------>
                    ...
                    #OUTROS BOTOES IMPORTANTES DA ATT--------------------->
                        ...
                        await bot.sendMessage(msg['message']['chat']['id'],'https://youtu.be/RakJkOu7BdE')
                        #return True
                    elif msg['data'].split()[0] == 'tutorial_uso_web':
